...
// World-space UI "quad" fragment shader -- the stock variant, RGBA-sampling the bound
// texture. Identical to ui_quad.frag apart from the occlusion prologue; see
// ui_world_occlude.glsl for why that prologue exists and why it is a branch, not a variant.
